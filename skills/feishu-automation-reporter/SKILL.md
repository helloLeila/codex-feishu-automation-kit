...
当用户希望把 Codex 自动化或其他 Markdown 生成流程推送到飞书 / Lark 自定义机器人时，使用这个 Skill。
...
4. 选择脚本：
   - AI 行业日报：`scripts/push-ai-daily-to-feishu.mjs`
   - 大湾区活动清单：`scripts/push-gba-events-to-feishu.mjs`
